  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          {state === "idle" && (
            <p style={{ color: "rgba(240,240,255,0.4)", fontSize: 13 }}>
              Press mic to start recording your voice message
            </p>
          )}
          {state === "recording" && (
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ fontSize: 13, color: "#FF6B9D", fontWeight: 600 }}>
                {formatTime(duration)}
              </span>
          ...
          {state === "recorded" && audioUrl && (
            <div>
              ...
              >
                ...
                <span style={{ fontSize: 12, color: "rgba(240,240,255,0.5)" }}>
            ...
            >
              ...
              {onSend && (
                <button
                  ...
                  onClick={() =>
                    onSend(audioUrl, mediaRef.current?._capturedBlob)
                  }
                >
                  <Send size={13} /> Send
                </button>
