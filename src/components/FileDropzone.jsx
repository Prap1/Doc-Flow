...
export default function FileDropzone({ onFiles, accept, multiple = true, label, sublabel, icon, color = '#6C63FF' }) {
  ...
  return (
    <motion.div
      ...
      style={{ borderColor: isDragActive ? color : undefined, cursor: 'pointer' }}
    >
      <input {...getInputProps()} />
      <motion.div
